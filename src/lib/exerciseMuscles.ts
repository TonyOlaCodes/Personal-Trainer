...
const EXERCISE_MUSCLE_OVERRIDES: Record<string, MuscleHit> = {
    ...
    "decline bench press": { primary: ["chest"], secondary: ["triceps", "shoulders"] },
    "decline dumbbell press": { primary: ["chest"], secondary: ["triceps", "shoulders"] },
    ...
    "pushup": { primary: ["chest"], secondary: ["shoulders", "triceps", "core"] },
    ...
    "weighted dip": { primary: ["chest", "triceps"], secondary: ["shoulders"] },
    ...
    // Back
    "pull up": { primary: ["lats", "upperBack"], secondary: ["biceps", "forearms"] },
    "pullup": { primary: ["lats", "upperBack"], secondary: ["biceps", "forearms"] },
    "chin up": { primary: ["lats", "biceps"], secondary: ["upperBack", "forearms"] },
    "lat pulldown": { primary: ["lats"], secondary: ["biceps", "upperBack"] },
    "seated cable row": { primary: ["lats", "upperBack"], secondary: ["biceps", "forearms"] },
    "cable row": { primary: ["lats", "upperBack"], secondary: ["biceps", "forearms"] },
    "barbell row": { primary: ["lats", "upperBack"], secondary: ["biceps", "lowerBack", "forearms"] },
    "bent over row": { primary: ["lats", "upperBack"], secondary: ["biceps", "lowerBack", "forearms"] },
    "dumbbell row": { primary: ["lats", "upperBack"], secondary: ["biceps", "forearms"] },
    "single arm dumbbell row": { primary: ["lats"], secondary: ["biceps", "upperBack", "forearms"] },
    "t bar row": { primary: ["lats", "upperBack"], secondary: ["biceps", "lowerBack"] },
    "deadlift": { primary: ["hamstrings", "glutes", "lowerBack"], secondary: ["traps", "forearms", "core", "quads"] },
    "romanian deadlift": { primary: ["hamstrings", "glutes"], secondary: ["lowerBack", "core"] },
    "rdl": { primary: ["hamstrings", "glutes"], secondary: ["lowerBack", "core"] },
