...
export const TERMS_SECTIONS: LegalSection[] = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            "You train at your own risk. You are solely responsible for deciding whether any workout, load, volume, or activity is appropriate for you.",
        ],
    },
    {
    ...
    {
        title: "7. Progress photos, videos, messages, and check-ins",
        paragraphs: [
    ...
    {
        title: "9. Account suspension or removal",
        paragraphs: [
    ...
    {
        title: "10. Payments and premium features",
        paragraphs: [
            "Some features may require premium access, often unlocked through a coach-provided access code or other arrangement described within the Platform.",
            "Unless expressly stated otherwise on the Platform, billing, refunds, and premium entitlements are managed between you and your coach or the applicable payment provider. We may update premium feature availability over time.",
            "If paid subscriptions or direct billing are introduced, additional payment terms will be presented before you are charged.",
        ],
    },
    {
        title: "11. Data accuracy and app availability",
        paragraphs: [
            "Workout logs, charts, estimates, and analytics are provided for convenience. They may contain errors, omissions, or delays. You should not rely on the Platform as the sole record for medical or legal purposes.",
    ...
    },
    {
        ...
        paragraphs: [
            ...
            "Your use of coaching advice, training plans, and health-related information is at your own risk.",
        ],
    },
    {
